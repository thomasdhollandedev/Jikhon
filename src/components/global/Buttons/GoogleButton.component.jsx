...
const GoogleButton = (darkMode = true) => {
    const xml = `
            ...
            style={[
                styles.googleButton,
                {
                    backgroundColor: darkMode
                        ? darkStyle.primaryText__VAR
                        : lightStyle.primaryText__VAR
                }
            ]}
        >
            <SvgXml
            ...
            <Text
                style={[
                    ...
                    global.textButton,
                    darkMode
                        ? darkStyle.textPrimaryElement__COLOR
                        : lightStyle.textPrimaryElement__COLOR
                ]}
            >
